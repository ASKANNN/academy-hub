  ...
  quiz: [
    ...
    },
    {
      ...
      options: [
        ...
        { ru: 'Не использует рекурсию', en: 'It doesn\'t use recursion' },
        { ru: 'Работает только с уже отсортированными массивами', en: 'It only works on already-sorted arrays' },
        { ru: 'Никак не отличается — это два названия одного и того же алгоритма', en: 'It doesn\'t differ at all — it\'s just another name for the same algorithm' },
      ],
      correct: 0,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { ru: 'Он отменяет все предыдущие сравнения', en: 'It undoes all previous comparisons' },
        { ru: 'Он нужен только для чётного числа элементов', en: 'It\'s only needed for an even number of elements' },
        { ru: 'Он вообще не влияет на результат', en: 'It has no effect on the result whatsoever' },
      ],
      correct: 0,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { ru: 'Обе требуют предварительно отсортированных входных данных', en: 'Both require the input to already be pre-sorted' },
        { ru: 'Обе работают только с целыми числами', en: 'Both only work with integers' },
        { ru: 'Обе имеют сложность O(n)', en: 'Both have O(n) complexity' },
      ],
      correct: 0,
      explanation: {
