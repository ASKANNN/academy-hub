export const bubbleSort = {
  ...
  details: {
    ...
    realWorld: [
      ...
      {
        ru: 'В открытых проектах пузырьковую идею находят в виде наследников: в **CPython** (`Objects/listobject.c`) - Timsort, чья логика работы с run-ами наследует insertion sort; в **ядре Linux** (`lib/sort.c`) - heapsort с оптимизациями; в **SQLite** (`src/vdbesort.c`) - внешняя сортировка на основе merge sort. Сама пузырьковая в продакшн-коде крупных проектов не встречается, но понимание её механики необходимо для понимания гибридов.',
